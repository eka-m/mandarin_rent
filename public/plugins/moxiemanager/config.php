...
$moxieManagerConfig['filesystem.rootpath'] =
    "RENT=/gopanel/sites/mandarin/public_html/public/uploads/RENT;";
//    media=" . $_SERVER["DOCUMENT_ROOT"] . "/uploads/media;
//    documents=" . $_SERVER["DOCUMENT_ROOT"] . "/uploads/documents;
//    other=" . $_SERVER["DOCUMENT_ROOT"] . "/uploads/other";
...
//		array("username" => "user", "password" => "password", "groups" => array("administrator"))
//	);
...
//     "/gopanel/sites/mandarin/public_html" => array(
//         "urlprefix" => "http://mandarinagency.az/",
//     ),
//     "/gopanel/sites/mandarin/public_html" => array(
//         "urlprefix" => "http://rent.mandarinagency.az/",
//     )
// );
