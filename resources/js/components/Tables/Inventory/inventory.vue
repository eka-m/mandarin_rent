<template>
    <div id="inventoryTableContainer">
        <filters :table="table" :prop-statuses="statuses" :prop-categories="categories"></filters>
        <div class="position-relative">
            <table class="table table-striped- table-bordered table-hover table-checkable" ref="inventoryTable">
                <thead>
                    <tr>
                        <th>ИД</th>
                        <th>И.Н.</th>
